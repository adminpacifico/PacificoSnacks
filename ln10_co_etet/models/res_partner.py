...
class Partner(models.Model):
    ...
    street_01 = fields.Many2one('ln10_co_etet.nomenclaturedian', ondelete='set null',
                                domain=[('type', '=', 'principal')])
    street_02 = fields.Integer(default='')
    street_03 = fields.Many2one('ln10_co_etet.nomenclaturedian', ondelete='set null',
                                domain=[('type', '=', 'letter')])
    street_04 = fields.Many2one('ln10_co_etet.nomenclaturedian', ondelete='set null',
                                domain=[('type', '=', 'qualifiying')])
    street_05 = fields.Many2one('ln10_co_etet.nomenclaturedian', ondelete='set null',
                                domain=[('type', '=', 'qualifiying')])
    street_06 = fields.Integer(default='')
    street_07 = fields.Many2one('ln10_co_etet.nomenclaturedian', ondelete='set null',
                                domain=[('type', '=', 'letter')])
    street_08 = fields.Many2one('ln10_co_etet.nomenclaturedian', ondelete='set null',
                                domain=[('type', '=', 'qualifiying')])
    street_09 = fields.Integer(default='')
    street_10 = fields.Many2one('ln10_co_etet.nomenclaturedian', ondelete='set null',
                                domain=[('type', '=', 'qualifiying')])
    street_11 = fields.Many2one('ln10_co_etet.nomenclaturedian', ondelete='set null',
                                domain=[('type', '=', 'additional')])
    street_12 = fields.Char(default='')
    street_13 = fields.Many2one('ln10_co_etet.nomenclaturedian', ondelete='set null',
                                domain=[('type', '=', 'additional')])
    street_14 = fields.Char(default='')
    street_15 = fields.Many2one('ln10_co_etet.nomenclaturedian', ondelete='set null',
                                domain=[('type', '=', 'additional')])
    street_16 = fields.Char(default='')

    dian_address = fields.Char(default='')

    # document_type = fields.One2many('ln10_co_etet.documenttype', 'key_dian', string='Document Type')
    document_type = fields.Many2one('ln10_co_etet.documenttype', ondelete='set null', string='Document Type')
    ...
    # person_type = fields.Many2one('ln10_co_etet.persontype', ondelete='set null', string='Person Type')
    person_type = fields.Many2one('ln10_co_etet.diancodes', ondelete='cascade', string='Person Type',
                                  domain=[('type', '=', 'persontype')])
    # fiscal_regime = fields.Many2one('ln10_co_etet.fiscalregime', ondelete='set null', string='Fiscal Regime')
    fiscal_regime = fields.Many2one('ln10_co_etet.diancodes', ondelete='cascade', string='Fiscal Regime',
                                    domain=[('type', '=', 'fiscalregime')])
    # fiscal_responsibility = fields.Many2one('ln10_co_etet.fiscalresponsibility', ondelete='set null', string='Fiscal Responsibility')
    # fiscal_responsibility = fields.Many2many('ln10_co_etet.fiscalresponsibility', column1='partner_id', column2='id', ondelete='set null', string='Fiscal Responsibility', domain="[('active', '=', True)]")
    fiscal_responsibility = fields.Many2many('ln10_co_etet.diancodes', relation='model_fiscal', column1='partner_id',
                                             column2='id', ondelete='cascade', string='Fiscal Responsibility',
                                             domain=[('type', '=', 'fiscalresponsibility')])
    payment_method = fields.Many2many('ln10_co_etet.diancodes', relation='model_payment', column1='partner_id',
    ...
    code_ciiu_primary = fields.Many2one('ln10_co_etet.ciiucodes', ondelete='cascade', string='Primary CIIU Code',
                                        domain="[('industry_id', '=?', industry_id)]")
    code_ciiu_secondary = fields.Many2many('ln10_co_etet.ciiucodes', column1='partner_id', column2='id',
    ...
    _sql_constraints = [
        ('document_type_number_uniq', 'UNIQUE(id)', 'NIT Unique!')]
