...
class AccountFiscalPosition(models.Model):
    ...
    def map_tax(self, taxes, product=None, partner=None):
        ...
        definidos en el modelo ln10_co_etet.relationfiscalpositions
        ...
        """
        Se consulta y almacena la relación entre posiciones fiscales para determinar los impuestos por su
        Tipo de Impuesto asociado. En caso de no encontrar, generará un error.
        """
        relation_fpos = self.env['ln10_co_etet.relationfiscalpositions']
...
class RealitonFiscalPositions(models.Model):
    _name = 'ln10_co_etet.relationfiscalpositions'
    ...
    tax_types_ids = fields.One2many('ln10_co_etet.aplicationtaxestype', 'relation_fiscal_position_id',
...
class TaxesTypeAplication(models.Model):
    _name = 'ln10_co_etet.aplicationtaxestype'
    _description = 'Define Tax Type application for Fiscal Position Relations'

    relation_fiscal_position_id = fields.Many2one('ln10_co_etet.relationfiscalpositions', 'Fiscal Position Relation')
    tax_type = fields.Many2one('ln10_co_etet.taxestype', 'Tax Type', required=True)
...
class AccountMoveTaxes(models.Model):
    ...
    tax_type_id = fields.Many2one('ln10_co_etet.taxestype')
