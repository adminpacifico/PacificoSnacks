...
class Company(models.Model):
    ...
    street_01 = fields.Many2one('ln10_co_etet.nomenclaturedian', compute='_compute_address',
    ...
    street_03 = fields.Many2one('ln10_co_etet.nomenclaturedian', compute='_compute_address',
                                related='partner_id.street_03',
                                inverse='_inverse_street_03', ondelete='set null', domain=[('type', '=', 'letter')])
    street_04 = fields.Many2one('ln10_co_etet.nomenclaturedian', compute='_compute_address',
                                related='partner_id.street_04',
                                inverse='_inverse_street_04', ondelete='set null',
                                domain=[('type', '=', 'qualifiying')])
    street_05 = fields.Many2one('ln10_co_etet.nomenclaturedian', compute='_compute_address',
    ...
    street_07 = fields.Many2one('ln10_co_etet.nomenclaturedian', related='partner_id.street_07',
                                compute='_compute_address',
                                inverse='_inverse_street_07', ondelete='set null', domain=[('type', '=', 'letter')])
    street_08 = fields.Many2one('ln10_co_etet.nomenclaturedian', compute='_compute_address',
    ...
    street_10 = fields.Many2one('ln10_co_etet.nomenclaturedian', compute='_compute_address',
                                related='partner_id.street_10',
                                inverse='_inverse_street_10', ondelete='set null',
                                domain=[('type', '=', 'qualifiying')])
    street_11 = fields.Many2one('ln10_co_etet.nomenclaturedian', compute='_compute_address',
    ...
    street_13 = fields.Many2one('ln10_co_etet.nomenclaturedian', compute='_compute_address',
    ...
    street_15 = fields.Many2one('ln10_co_etet.nomenclaturedian', related='partner_id.street_15',
                                compute='_compute_address',
    ...
    document_type = fields.Many2one('ln10_co_etet.documenttype', related='partner_id.document_type',
